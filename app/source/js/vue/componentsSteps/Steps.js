Vue.component('v-steps', {
    ...
    '               <v-button @clicked="finishStep" v-if="isLastStep" :in-form="false" classes="v-col d-inline" classes-btn="btn btn-success"><slot name="finishBtn">{{finishBtnLabel}}</slot></v-button>' +
    '           </div>' +
    '       </div>' +
    '   </div>' +
    '   <div class="row">' +
